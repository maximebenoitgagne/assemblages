...
# set constants
CSV_DIR="run_20240912_0000_EXP2_3_122_sims_par_nomixogmax"
RBCS_FILES="rbcs_files_nomixogmax.txt"
RUN_DIR_PREFIX="run_20240912_0000_EXP2_3"
RUN_DIRS="run_dirs_exp2_nomixogmax.txt"
...
./mitgcmuv_one_exp2_nomixogmax.sh "${run_dir}" "${rbcs_file}"
