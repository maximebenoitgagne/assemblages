...
# set constants
date=$(date '+%Y%m%d')
BUILD_DIR="build_code_20240214_0000_EXP0_defineDARWIN_DIAG_PERTYPE"
DIAGS_DIR="diags_${date}_0001"
MITGCMUV_NAME="mitgcmuv_20240214_0000_EXP0_defineDARWIN_DIAG_PERTYPE"
PREVIOUS_DIR="run_20230920_0000_EXP0_reference"
...
# move output
cp available_diagnostics.log data data.cal data.diagnostics data.exf data.gchem data.gud data.kpp data.mnc data.off data.pkg data.ptracers data.rbcs data.traits gud_params.txt gud_traits.txt ${DIAGS_DIR} 
